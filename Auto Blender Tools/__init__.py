...
if 'bpy' in locals():
    ...
    if 'AutoMaterialTools' in locals():
        importlib.reload(AutoMaterialTools)
else:
    import bpy
    from . import (RenderTemplate)
    from . import (AutoDenoise)
    from . import (AutoMaterialTools)
...
def register():
    ...
    denoise_register()
    from .AutoMaterialTools import material_register
    material_register()
...
def unregister():
    ...
    denoise_unregister()
    from .AutoMaterialTools import material_unregister
    material_unregister()
